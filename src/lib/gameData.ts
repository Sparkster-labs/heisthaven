...
export const CREW_MEMBERS = [
  ...
  },
  {
    ...
    name: 'Mako Reyes',
    role: 'Smuggler',
    specialty: 'contraband_routes',
    emoji: '🦈',
    flavor: 'Runs contraband through stormwater channels nobody else can navigate.',
    baseCost: 14000,
    unlocked: false,
  },
  {
    ...
    name: 'Anchor Briggs',
    role: 'Enforcer',
    specialty: 'frontline_control',
    emoji: '⚓',
    flavor: 'Ex-dock boss with a steel chain and zero hesitation.',
    baseCost: 16000,
    unlocked: false,
  },
  {
    ...
    name: 'Drift',
    role: 'Lookout',
    specialty: 'escape_vectors',
    emoji: '🌊',
    flavor: 'Reads crowd flow and police movement like ocean currents.',
    baseCost: 18000,
    unlocked: false,
  },
  {
    ...
    name: 'Ledger Quinn',
    role: 'Forger',
    specialty: 'paper_trails',
    emoji: '📓',
    flavor: 'Can make a fake transfer look cleaner than a real one.',
    baseCost: 22000,
    unlocked: false,
  },
  {
    ...
    name: 'Vanta Vale',
    role: 'Negotiator',
    specialty: 'high_society_bluffs',
    emoji: '🕴️',
    flavor: 'Talks her way into boardrooms and out of indictments.',
    baseCost: 20000,
    unlocked: false,
  },
  {
    ...
    name: 'Proxy Nine',
    role: 'Fixer',
    specialty: 'contingency_plans',
    emoji: '♟️',
    flavor: 'Always has a backup plan, and a backup for that backup.',
    baseCost: 24000,
    unlocked: false,
  },
] as const;
